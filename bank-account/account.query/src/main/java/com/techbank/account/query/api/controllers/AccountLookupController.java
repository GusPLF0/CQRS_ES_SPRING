...
public class AccountLookupController {
    ...
    public ResponseEntity<AccountLookupResponse> getAllAccounts() {
        try {
            ...
            var response = AccountLookupResponse.builder()
                    .accounts(accounts)
                    .message(MessageFormat.format("Successfully return {0} bank account(s)", accounts.size()))
                    .build();
    ...
    @GetMapping(path = "/byId/{accountHolder}")
    ...
    @GetMapping(path = "/byId/{equalityType}/{balance}")
